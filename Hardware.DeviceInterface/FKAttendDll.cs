...
namespace Hardware.DeviceInterface
{
    ...
    public struct FKUser
    {
        public UInt32 vEnrollNumber;  
        public int vBackupNumber;   
        public int vPrivilege;  
        public int vnEnableFlag;
        public byte[] mbytCurEnrollData;

        public void Init(UInt32 enrollNumber, int backupNumber, int privilege, int enableFlag, byte[] enrollData)
        {
            vEnrollNumber = enrollNumber;
            vBackupNumber = backupNumber;
            vPrivilege = privilege;
            vnEnableFlag = enableFlag;
            mbytCurEnrollData = enrollData;
        }
    }
