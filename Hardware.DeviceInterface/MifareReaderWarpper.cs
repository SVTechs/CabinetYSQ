...
{
    public class MifareReaderWarpper
    {
        ...
        public static Int16 rf_load_key_hex(int icdev, int mode, int secnr, string keybuff)
        {
            byte[] key = Encoding.ASCII.GetBytes(keybuff);
            return rf_load_key_hex(icdev, mode, secnr, key);
        }
        ...
        [DllImport("mwrf32.dll", EntryPoint = "rf_reset", SetLastError = true,
             ...
             CallingConvention = CallingConvention.StdCall)]
        //说明：     返回设备当前状态
        public static extern Int16 rf_clr_reset(int icdev, int msec);

        [DllImport("mwrf32.dll", EntryPoint = "rf_clr_control_bit", SetLastError = true,
             CharSet = CharSet.Auto, ExactSpelling = false,
             CallingConvention = CallingConvention.StdCall)]
        //说明：     返回设备当前状态
        public static extern Int16 rf_clr_control_bit(int icdev, int b);
        ...
        [DllImport("mwrf32.dll", EntryPoint = "rf_set_control_bit", SetLastError = true,
             ...
             CallingConvention = CallingConvention.StdCall)]
        //说明：     返回设备当前状态
        public static extern Int16 rf_set_control_bit(int icdev, int b);
