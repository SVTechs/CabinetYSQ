...
namespace UpdateControl
{
    ...
    public class Util_FTP
    {
        ...
        public Util_FTP(string FtpServerIP, string FtpRemotePath, string FtpUserID, string FtpPassword)
        {
        ...
        public void Upload(string filename)
        {
            ...
            {
                MessageBox.Show(filename + " 上传失败,错误: " + e.Message);
            }
        }
        ...
        {
            string[] directory = GetFilesDetailList();
