...
public class SqlHelper
{
    ...
    //public static readonly string LocalDB = "Data Source=.;Initial Catalog=AppDB;User Id=sa;Password=Xlt62142100;";
    public static readonly string LocalDB = "Data Source=LocalHost\\SQLExpress;Initial Catalog=AppDB;User ID=sa;password=XLT@62142100 ";
    ...
    public static DataTable getdataTable(string connectionString, CommandType CType, string CmdText, params SqlParameter[] spr)
    {
        SqlCommand cmd = new SqlCommand();
        SqlConnection conn = new SqlConnection(GetPoolingString(connectionString));
