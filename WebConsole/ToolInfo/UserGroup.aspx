<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserGroup.aspx.cs" Inherits="ToolInfo.UserGroup" %>
...
<head runat="server">
    ...
    <script>
        ...
        var itemClick = function (view, record, item, index, e) {
            ...
            if (subItem) {
                location.href = '/ToolRecord/IoRecordQuery.aspx?workId=' + subItem.id;
            }
        };
