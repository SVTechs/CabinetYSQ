...
using FKCollector.Config;
using Configuration = NHibernate.Cfg.Configuration;

namespace FKCollector.Dal.NhUtils
{
                ...
                switch (reqDb)
                {
                    case 0:
                        ...
                        SessionFactory[reqDb] = Fluently.Configure()
                            .Database(MsSqlConfiguration.MsSql2005.ConnectionString(ConfigurationManager.ConnectionStrings["cabinet"].ConnectionString).IsolationLevel(IsolationLevel.RepeatableRead))
